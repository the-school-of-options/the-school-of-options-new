...
import fischerBlackImage from "@/assets/fischer-black.jpg";
import myronScholesImage from "@/assets/myron-scholes-alt.jpg";
import robertMertonImage from "@/assets/robert-merton.jpg";

const DedicationAndVideosSection = () => {
  const nobelLaureates = [
    {
      name: "Fischer Black",
      imageUrl: fischerBlackImage,
      bio: "Co-developer of the Black–Scholes model for pricing options.",
      wikiUrl: "https://en.wikipedia.org/wiki/Fischer_Black"
    },
    {
      name: "Myron Scholes",
      imageUrl: myronScholesImage,
