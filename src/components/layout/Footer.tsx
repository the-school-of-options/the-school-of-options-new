        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col space-y-2">
              <Link to="/methodology" className="text-sm text-white/80 hover:text-white smooth-transition">
                Our Methodology
              </Link>
            </nav>
          </div>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col space-y-2">
              <Link to="/about" className="text-sm text-white/80 hover:text-white smooth-transition">
                About Us
              </Link>
              <Link to="/faq" className="text-sm text-white/80 hover:text-white smooth-transition">
                FAQ
              </Link>
            </nav>
          </div>
        ...
        <div className="border-t border-white/20 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6 text-sm">
              <Link to="/privacy" className="text-white/70 hover:text-white smooth-transition">
                Privacy Policy
              </Link>
              <Link to="/terms" className="text-white/70 hover:text-white smooth-transition">
                Terms of Service
              </Link>
              <Link to="/risk-disclosure" className="text-white/70 hover:text-white smooth-transition">
                Risk Disclosure
              </Link>
            </div>
          </div>
