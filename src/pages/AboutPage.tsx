            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="bg-accent/10 rounded-lg p-6 border border-accent/20">
                  ...
                  <cite className="text-sm text-muted-foreground mt-2 block">— Kundan Kishore</cite>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 lg:py-24 section-bg">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-background rounded-lg p-8 shadow-medium border">
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Started journey with markets in Gaya, Bihar. Years of losses and learning.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2">First Course Launch</h3>
                  <p className="text-muted-foreground">Launched first comprehensive options trading course.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2">Advanced Programs</h3>
                  <p className="text-muted-foreground">Introduced advanced Options and statistical arbitrage programs.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Started intensive 6-month mentorship program.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2">The School of Options</h3>
                  <p className="text-muted-foreground">Platform launch with comprehensive ecosystem for options education.</p>
                </div>
              </div>
            </div>
          </div>
