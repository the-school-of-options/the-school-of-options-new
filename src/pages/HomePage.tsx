...
import { CheckCircle, TrendingUp, Users, Shield, BookOpen, Target, Linkedin, Facebook, Instagram, Twitter, MessageCircle } from "lucide-react";
...
const HomePage = () => {
  ...
  const features = [
    {
      icon: BookOpen,
      title: "40 Essential Options Concepts",
      description: "From derivatives to Greeks, simplified for real understanding"
    },
    {
      icon: Target,
      title: "Backtesting & Paper Trading",
      description: "Practice without risk, build confidence with data"
    },
    {
      icon: Shield,
      title: "Personalized Trading Plan",
      description: "Aligned to your capital and risk tolerance"
    },
    {
      icon: Users,
      title: "6 Months Live Mentorship",
      description: "Weekly calls and personalized guidance"
    }
  ];
            ...
            <div className="max-w-[1120px] mx-auto">
              ...
              <div className="text-container text-center mb-8">
                ...
                <Button 
                  ...
                  asChild
                >
                  <Link to="/methodology" aria-label="Open the Methodology page">
      ...
      <section className="py-[88px] px-6 bg-[#F7F9FB]">
        <div className="max-w-[1120px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            {/* Course 1 - Hindi */}
            <div className="bg-white border border-black/6 rounded-[14px] shadow-[0_6px_18px_rgba(0,0,0,0.06)] p-6 relative">
              ...
              <p className="text-[15px] text-[#1A202C] leading-[1.55] mb-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener"
                className="inline-block w-full text-center px-5 py-3 bg-primary hover:bg-navy-light text-white font-bold rounded-[12px] shadow-[0_8px_22px_rgba(10,37,64,0.22)] transition-all duration-200 hover:scale-[1.02]"
